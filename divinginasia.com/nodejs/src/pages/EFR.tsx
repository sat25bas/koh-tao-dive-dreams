...
const EFR: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <section className="relative h-64 md:h-80 flex items-center" style={{backgroundImage: "linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.35)), url('https://api.divinginasia.com/images/efr.jpeg')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
