...
const FoodDrink = () => {
  ...
  <main className="max-w-4xl mx-auto">
    ...
    <section className="relative h-64 md:h-96 flex items-center justify-center mb-8 overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://github.com/one-media-asia/koh-tao-dive-dreams/blob/main/images/thefunkyturtle.com-restaurants-on-koh-tao-the-gallery.jpg')] bg-cover bg-center" />
